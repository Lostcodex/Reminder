  ...
  return (
    ...
    >
      <motion.div 
        layout
        className={cn(
          "group relative flex items-center gap-4 p-4 flex-1 rounded-2xl bg-card border border-border/50 shadow-sm transition-all duration-300 hover:shadow-md",
      ...
      {onDelete && (
        <button
          ...
          className="p-2 rounded-lg hover:bg-red-500/10 transition-colors text-muted-foreground hover:text-red-500 flex-shrink-0"
        >
          <Trash2 size={20} />
        </button>
      )}
